...
public class changePhone extends javax.swing.JFrame implements WindowListener{

    /**
     * Creates new form changePhone
     */
	private UpdateCustomer updateCustomer;
    public changePhone(UpdateCustomer updateCustomer) {
        initComponents();
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	if(phoneField.getText().length()>10||phoneField.getText().length()<10||check(phoneField.getText())==-1) {
    		...
    		warningMessage.setVisible(true);
    		updateCustomer.setPhoneLabel(phoneField.getText());
    	}
    }
