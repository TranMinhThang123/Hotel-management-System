...
public class changeLastNameEmployee extends javax.swing.JFrame implements WindowListener{

    /**
     * Creates new form changeLastname
     */
	private UpdateEmployee updateEmployee;
    public changeLastNameEmployee(UpdateEmployee updateEmployee) {
        initComponents();
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	updateEmployee.setLatsNameEmployeeLabel(lastnameField.getText());
    }
