...
public class changeFirstnameEmployee extends javax.swing.JFrame implements WindowListener{

    /**
     * Creates new form changeFirstname
     */
	private UpdateEmployee updateEmployee;
    public changeFirstnameEmployee(UpdateEmployee updateEmployee) {
        initComponents();
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	updateEmployee.setFirstNameEmployeeLabel(firstnameField.getText());
    }
