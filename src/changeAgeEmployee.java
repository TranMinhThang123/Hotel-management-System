...
public class changeAgeEmployee extends javax.swing.JFrame implements WindowListener{

    /**
     * Creates new form changeAge
     */
	private UpdateEmployee updateEmployee;
    public changeAgeEmployee(UpdateEmployee updateEmployee) {
        initComponents();
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	if(check(ageField.getText())!=-1) {
    		warningMessage.setHorizontalAlignment(SwingConstants.CENTER);
            warningMessage.setVerticalAlignment(SwingConstants.CENTER);
    		updateEmployee.setAgeEmployeeLabel(ageField.getText());
